...
<body>
    <div class="container mt-5">
        ...
        <form action="{{ route('students.store') }}" method="POST">
            ...
            <div class="mb-3">
                <label>GPA</label>
                <input type="number" name="gpa" step="0.1" min="0" max="4" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-primary">Thêm <i class="fa-solid fa-plus"></i></button>
